...
const formSchema = z.object({
  name: z.string().min(1, { message: "Comapanion name is required" }),
    ...
    const form = useForm<z.infer<typeof formSchema>>({
      ...
      const onSubmit =async(values: z.infer<typeof formSchema>) =>{
        ...
        if (companion){
            ...
            alert("Failed to create companion, please try again later.");
            redirect("/");
        }
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Ex: Englsih and literature" {...field}  className="input"/>
              </FormControl>
